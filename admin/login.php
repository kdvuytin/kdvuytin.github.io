                    ...
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            ...
                            <form method="post">
                                ...
                                <div class="text-center d-flex justify-content-between mt-4"><p>Design By <a href="https://www.facebook.com/mlong.it"  style="text-decoration: none;color: blue">Nguyễn Minh Long</a></p></div>
                            </form>
                        </div>
                    </div>
                </div><!-- End -->
...
.bg-image {
  background-image: url('https://i.pinimg.com/originals/d0/53/f2/d053f2394d420d8d3712046f4e8f80cc.jpg');
