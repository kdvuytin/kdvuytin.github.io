...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="//zalo.me/hvd2k3" class="nav-link">LIÊN HỆ KỸ THUẬT</a>
        </li>
    </ul>
    <!-- Right navbar links -->
                ...
                <a href="#" class="dropdown-item">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="text-sm">Nếu Gặp Lỗi Hoặc Trục Trặc Trong Quá Trình Quản Lí Hãy Liên Hệ Tôi Bằng Cách Nhấn Nút Liên Hệ Kĩ Thuật Ngay Bên Cạnh</p>
