            ...
            <div class="modal-body">
                <form role="form" action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="number" placeholder="Nhập Mã Số Của GDV" required="">
                    </div>
                    
                    <div class="form-group">
                    <label for="exampleInputEmail1">NGÂN HÀNG ( XEM CÁCH NHẬP TK NGÂN HÀNG <a href="/dnamadmincs/huongdan.html"><b>TẠI ĐÂY</b></a>)</label>
                    <input type="text" name="nganhang" class="form-control" placeholder="VD : MB BANK , VIETTINBANK ..." >
                    </div>
                    
                    <div class="form-group">
                    <label for="exampleInputEmail1">DỊCH VỤ CUNG CẤP ( XEM CÁCH NHẬP DVCC <a href="/dnamadmincs/huongdan.html"><b>TẠI ĐÂY</b></a>)</label>
                    <input type="text" name="dichvucungcap" class="form-control" placeholder="VD : Mua bán acc fi fai ..." >
                    </div>
                    
                    <div class="form-group">
                    <label for="exampleInputEmail1">LỆ PHÍ TRUNG GIAN ( CÁCH NHẬP NHƯ TK NGÂN HÀNG <a href="/dnamadmincs/huongdan.html"><b>TẠI ĐÂY</b></a>)</label>
                    <input type="text" name="trunggian" class="form-control" placeholder="VD : 1-100: phí 2k , 100-500: phí 5k..." >
                    </div>
                    
                    <div class="form-group">
                    <label for="exampleInputEmail1">MÔ TẢ</label>
                    <input type="text" name="mota" class="form-control" placeholder="VD : Đep trai" >
                    </div>
